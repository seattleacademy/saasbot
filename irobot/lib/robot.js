...
Robot.prototype.setRTS = function (command) {
this.serial.set({rts:true});
console.log('setRTStrue');
for(let i=0; i<100000000; i++){

}
this.serial.set({rts:false});
console.log('setRTSfalse'); 
  this.serial.flush();
...
Robot.prototype.drive = function (velocity, radius) {
  ...
  if (_.isNumber(velocity)) {
    ...
    data.writeInt16BE(velocityRight, 0);
    data.writeInt16BE(velocityLeft, 2);
  }
